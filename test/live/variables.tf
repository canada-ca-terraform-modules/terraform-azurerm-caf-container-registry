variable "env" {
  description = "Environment prefix used in the generated container registry name"
  type        = string
  default     = "livetest"
}
...
variable "tags" {
  description = "Tags applied to the container registry created by this harness"
  type        = map(string)
  default = {
...
variable "container_registry" {
  description = "Container registry configuration object, passed straight through to the module under test"
  type        = any
}
